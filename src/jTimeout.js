...
(function ($) {
    ...
    $.jTimeout.defaults = {
        ...
        logoutUrl: './Logout.php', //URL to request in order to force a logout after the timeout. This way you can end a session early based on a shorter timeout OR if the front-end timeout doesn't sync with the backend one perfectly, you don't look like an idiot.
        loginUrl: './login.php', //URL to send a customer when they want to log back in
        secondsPrior: 10, //how many seconds before timing out to run the next callback (onPriorCallback)
